        ...
        while i < len(dataset):
            ...
            for j in range(len(refs)):
                ...
                for k in range(num_markables):
                    ...
                    _num_ref_tgt.append(sum(refs[j][10 * k + 3: 10 * (k + 1)]))
                ref_inpt.append(_ref_inpt)
                ref_tgt.append(_ref_tgt)
                num_ref_tgt.append(_num_ref_tgt)
            ...
            if num_markables == 0:
                ...
                num_ref_tgt = torch.Tensor(num_ref_tgt).long()
            ...
            batches.append((ctx, inpt, tgt, ref_inpt, ref_tgt, num_ref_tgt, sel_tgt, scenario_ids, real_ids, agents, chat_ids, sel_idxs))
