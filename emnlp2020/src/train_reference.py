...
def main():
    ...
    parser.add_argument('--num_ref_weight', type=float, default=1.0,
        help='reference loss weight')
    ...
    parser.add_argument('--remove_location', action='store_true', default=False,
        help='remove locative information from input')
    parser.add_argument('--remove_size', action='store_true', default=False,
        help='remove size information from input')
    parser.add_argument('--remove_color', action='store_true', default=False,
        help='remove color information from input')
    parser.add_argument('--remove_size_color', action='store_true', default=False,
    ...
    for seed in seeds:
        ...
        corpus = model_ty.corpus_ty(domain, args.data, train='train_reference_shift_{}.txt'.format(seed), valid='valid_reference_shift_{}.txt'.format(seed), test='test_reference_shift_{}.txt'.format(seed),
